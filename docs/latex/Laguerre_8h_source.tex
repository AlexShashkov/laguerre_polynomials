...
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00031\ \ \ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classLaguerre_1_1Original_aa36a248c344f0a7f4b1ea95988ad605a}{laguer}}(\textcolor{keyword}{const}\ std::vector<std::complex<T>>\&\ a,\ std::complex<T>\&\ x,\ \textcolor{keywordtype}{int}\&\ converged,\ \textcolor{keywordtype}{int}\ itmax)\{\ \ \ \ \ \ \ \ }
...
\DoxyCodeLine{00103\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classLaguerre_1_1Original_aa36a248c344f0a7f4b1ea95988ad605a}{laguer}}(ad\_v,\ x,\ conv[j],\ itmax);}
\DoxyCodeLine{00104\ }
